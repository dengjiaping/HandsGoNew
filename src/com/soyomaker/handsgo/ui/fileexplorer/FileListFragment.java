...
public class FileListFragment extends Fragment implements IFileInteractionListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        boolean baseSd = intent.getBooleanExtra(FileExplorerConstants.KEY_BASE_SD,
                !isReadRoot(mActivity));
        ...
        if (!TextUtils.isEmpty(rootDir)) {
            ...
            rootDir = baseSd ? FileListFragment.sdDir : FileExplorerConstants.ROOT_PATH;
        }
    ...
    public static String getPrimaryFolder(Context context) {
        ...
        String primaryFolder = settings.getString(PRIMARY_FOLDER, FileExplorerConstants.MNT_PATH);

        if (TextUtils.isEmpty(primaryFolder)) {
            primaryFolder = FileExplorerConstants.ROOT_PATH;
        }
